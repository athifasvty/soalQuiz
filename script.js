document.addEventListener("DOMContentLoaded", function () {
    ...
    function createConfettiPiece() {
        ...
        confetti.style.top = "-10vh"; // Mulai dari atas layar
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Data hadiah masing-masing juara
    const prizes = {
    ...
    // Event listener untuk klik pada kartu pemenang
    winners.forEach(box => {
        box.addEventListener("click", function () {
            const prizeClass = this.classList[1]; // Ambil class juara (first, second, third)
